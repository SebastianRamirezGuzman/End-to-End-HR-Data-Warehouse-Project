...
Ejecutar el script SQLQuery_STG_RRHH.sql para la ingesta inicial.

Ejecutar SQLQuery_ODS_RRHH.sql para la limpieza y transformación.

Ejecutar SQLQuery_BDS_RRHH.sql para generar el modelo dimensional.
